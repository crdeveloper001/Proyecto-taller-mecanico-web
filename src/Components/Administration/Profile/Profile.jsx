                                    ...
                                    <Col md={5}>
                                        ...
                                        <Form.Group controlId="InputName">
                                            ...
                                            <Form.Control type="text" disabled={enableField}
                                                          value={currentSession.Payload.Name} onChange={(e) => {
                                        ...
                                        <Form.Group controlId="InputLastName">
                                            ...
                                            <Form.Control type="text" disabled={enableField}
                                                          value={currentSession.Payload.Surname} onChange={(e) => {
                                                saveProfileInformationByUser(e)
                                            }}/>
                                        </Form.Group>
                                        <Form.Group controlId="InputEmail">
                                            ...
                                            <Form.Control type="email" disabled={enableField}
                                                          value={currentSession.Payload.CurrentEmail} onChange={(e) => {
                                                saveProfileInformationByUser(e)
                                            }}/>
                                        </Form.Group>
                                        <Form.Group controlId="InputPhone">
                                            ...
                                            <Form.Control type="tel" disabled={enableField}
                                                          value={currentSession.Payload.Phone} onChange={(e) => {
                                                saveProfileInformationByUser(e)
                                            }}/>
                                        </Form.Group>
                                    </Col>
